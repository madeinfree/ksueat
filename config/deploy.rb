...
role :web, "ksueat.com"                          # Your HTTP server, Apache/etc
role :app, "ksueat.com"                         # This may be the same as your `Web` server
role :db,  "ksueat.com"   , :primary => true # This is where Rails migrations will run
